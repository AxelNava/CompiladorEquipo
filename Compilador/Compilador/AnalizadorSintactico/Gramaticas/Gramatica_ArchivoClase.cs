            ...
            {
                {
                    0, new Dictionary<string, AbstractActionFunction>()
                    {
                        ...
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.USING), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 3)
                        },
                        {"<ARCHIVOCLASE>", new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.GOTO, 1) },
                        {"<USING>", new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.GOTO, 2) }
                    }
                },
                {
                    1, new Dictionary<string, AbstractActionFunction>()
                    {
                        {"FinCadena", new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.ACEPTACION, 12) }
                    }
                },
                {
                    ...
                    {
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.CLASS), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 7)
                        },
                ...
                },
                {
                    ...
                    {
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.Identificador), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 6)
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    {
                        {"FinCadena", new ReducedAction("ARCHIVOCLASE", new []{tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.FINCADENA)}) }
                    }
                },
                {
                    ...
                    {
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.PUNTOYCOMA), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 8)
                        },
                        { "Lambda", new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 4) },
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.USING), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 3)
                ...
                },
                {
                    ...
                    {
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.Identificador), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 9)
                        },
                    }
                },
                {
                    ...
                    {
                        {"<USING>", new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.GOTO, 13) }
                    }
                },
                {
                    ...
                    {
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.LLAVEABRE), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 10)
                        },
                    }
                },
                {
                ...
                },
                {
                    ...
                    {
                        {
                            tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.LLAVECIERRA), new AccionFuncion_TablaAnalisis(AbstractActionFunction.ActionEnum.DESPLAZAMIENTO, 12)
                        },   
                ...
                },
                {
                    ...
                    {
                         {"FinCadena", new ReducedAction("NOMBRECLASE", new []{tokensNameGlobal.selectorString(tokensNameGlobal.tokensGlobals.FINCADENA)}) }
                    }
                },
                {
